...
// This endpoint (/api/auth/login) should be protected by a Cloudflare Rate Limiting Rule
// configured in the Cloudflare dashboard to prevent abuse and brute force attacks.

import { getCORS, res, preflight, supabase, signToken, verifyPassword, calcStreak, parseBody } from '../../_utils.js';
